...
const infoData = [
  { title: "Phone", description: "(+880) 1962525093", icon: <Phone /> },
  { title: "Email", description: "biplob.code.bd@gmail.com", icon: <Mail /> },
  {
    title: "Address",
    description: "Krishnanagar , Jahikargachha , Jashore",
    icon: <MapPinCheck />,
  },
];
