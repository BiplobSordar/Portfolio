  ...
  experience: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Developed a complete school management system with multiple user roles (Admin, Teacher, Student, Parent). Features include student enrollment, attendance tracking, grade management, fee collection, exam scheduling, and dynamic report generation. Built with MERN stack, integrated PDF exports, and real-time notifications using Socket.io.",
        highlights: [
          "React.js",
          "Node.js",
          "Express.js",
      ...
      },
      {
        ...
        period: "Nov 2025",
        description:
          "Designed and developed a full-stack MERN application for managing pet adoption listings and orders. Built with React.js and Tailwind CSS frontend, Node.js/Express.js backend with JWT authentication, and MongoDB database. Implemented user dashboards, PDF exports, and Firebase Authentication.",
        highlights: [
          "React.js",
          "Node.js",
          "Express.js",
      ...
      },
      {
        ...
        description:
          "Developed a modern, full-stack blogging platform with Next.js frontend and Express.js backend. Implemented NextAuth authentication, role-based access control (Admin/User), CRUD operations for posts, and responsive design with optimized API calls.",
        highlights: [
          "Next.js",
          "Express.js",
          "MongoDB",
    ...
    items: [
      {
        ...
        period: "2024",
        description:
          "Completed intensive web development course covering MERN stack, modern development practices, and full-stack project building. Gained hands-on experience with React, Node.js, MongoDB, and deployment.",
        achievements: [
      ...
      },
      {
        ...
        period: "2024 - Present",
        description:
          "Currently pursuing degree in Political Science while continuing to develop technical skills through self-study and project work.",
        achievements: [
          "Active Student",
          "Balancing Tech Studies with Formal Education",
        ],
      },
      {
    ...
    categories: [
      {
        ...
        description:
          "Proficient in building responsive, interactive user interfaces with modern React ecosystem. Experience with state management, component architecture, and performance optimization.",
        skills: [
          "React.js",
          "Next.js",
          "Redux Toolkit",
      ...
      },
      {
        ...
        description:
          "Skilled in building RESTful APIs, authentication systems, and database architecture using Node.js and Express. Experience with both SQL and NoSQL databases.",
        skills: [
          "Node.js",
          "Express.js",
          "REST APIs",
      ...
      },
      {
        name: "Tools & DevOps",
        description:
          "Familiar with version control, API testing, deployment platforms, and basic DevOps concepts. Strong soft skills in problem-solving and collaboration.",
        skills: [
          "Git/GitHub",
          "Postman",
          "Vercel",
        ...
        >
          <Tabs defaultValue="experience" className="w-full">
            <div className="flex flex-col md:flex-row gap-6 md:gap-10">
              {/* Tabs List: horizontal scroll on mobile, vertical sidebar on desktop */}
            <TabsList className="flex flex-col mt-10 md:mt-0 w-full md:w-64 gap-3 bg-transparent">
  {tabMenu.map((item) => (
    <TabsTrigger
      key={item.value}
      value={item.value}
    ...
    >
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <span>{item.title}</span>
              ...
              {/* Content Area */}
              <div className="flex-1 mt-10 md:mt-0 min-h-[400px]">
                {/* Experience Tab */}
                ...
                <TabsContent value="about">
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      <div>
                        <h3 className="text-base sm:text-lg font-semibold mb-2">Interests</h3>
                        <div className="flex flex-wrap gap-2">
                      ...
                      <div>
                        <h3 className="text-base sm:text-lg font-semibold mb-2">Languages</h3>
                        <div className="flex flex-wrap gap-2">
